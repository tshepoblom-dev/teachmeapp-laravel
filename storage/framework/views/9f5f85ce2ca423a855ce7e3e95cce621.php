...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.emails.layout','data' => ['subject' => __('Session ended')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['subject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Session ended'))]); ?>
    <p class="greeting">Session wrapped up</p>
    <p class="intro"><?php echo e($message); ?></p>

    <?php if($netEarned): ?>
    <div class="alert">
        R<?php echo e(number_format($netEarned, 2)); ?> has been credited to your wallet.
    </div>
    <?php endif; ?>
    ...
    <div class="card">
        ...
        <div class="card-row">
            ...
            <span class="card-value"><?php echo e($durationMinutes); ?> minute(s)</span>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\teachmeapp-laravel\resources\views\emails\session-ended.blade.php ENDPATH**/ ?>