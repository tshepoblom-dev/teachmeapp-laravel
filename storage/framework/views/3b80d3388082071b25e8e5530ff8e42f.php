...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.emails.layout','data' => ['subject' => __('Congratulations — tier upgrade')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['subject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Congratulations — tier upgrade'))]); ?>
    ...
    <div class="card">
        <div class="card-row">
            ...
            <span class="card-value"><?php echo e($tierName); ?></span>
        </div>
        <div class="card-row">
            <span class="card-label">Commission rate</span>
            <span class="card-value"><?php echo e($commissionRate); ?>%</span>
        </div>
    </div>

    <div class="btn-wrap">
        <a class="btn" href="<?php echo e(config('app.url')); ?>/dashboard">View Dashboard</a>
    </div>
...
<?php endif; ?><?php /**PATH C:\teachmeapp-laravel\resources\views\emails\tier-upgraded.blade.php ENDPATH**/ ?>