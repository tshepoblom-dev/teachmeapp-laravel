...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.emails.layout','data' => ['subject' => __('Your booking has been accepted')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['subject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Your booking has been accepted'))]); ?>
    ...
    <div class="card">
        ...
        <div class="card-row">
            ...
            <span class="card-value"><?php echo e($tutorName); ?></span>
        </div>
        <div class="card-row">
            <span class="card-label">Scheduled</span>
            <span class="card-value"><?php echo e($scheduledAt); ?></span>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\teachmeapp-laravel\resources\views\emails\booking-accepted.blade.php ENDPATH**/ ?>