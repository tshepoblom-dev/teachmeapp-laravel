...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="invoice-number"><?php echo e($invoiceNumber); ?> <span class="paid-badge">Paid</span></div>
        </div>
    </div>
    ...
    <div class="meta">
        <div class="meta-cell">
            ...
            <div class="meta-value"><?php echo e($issuedAt->format('d M Y')); ?></div>
        </div>
        <div class="meta-cell">
            <div class="meta-label">Session Date</div>
            <div class="meta-value"><?php echo e($scheduledAt->format('d M Y')); ?></div>
            <div class="meta-sub"><?php echo e($scheduledAt->format('H:i')); ?> — <?php echo e($booking->duration_minutes); ?> min</div>
        </div>
    ...
    <div class="parties">
        <div class="party">
            ...
            <div class="party-name"><?php echo e($student->name); ?></div>
            <div class="party-email"><?php echo e($student->email); ?></div>
        </div>
        <div class="party">
            <div class="party-title">Tutor</div>
            <div class="party-name"><?php echo e($tutor->name); ?></div>
            <div class="party-email"><?php echo e($tutor->email); ?></div>
        </div>
    </div>
    ...
    <div class="items-wrap">
        <table class="items-table">
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="item-subject"><?php echo e($booking->subject); ?> Tutoring Session</div>
                        <div class="item-meta">Booking #<?php echo e($booking->id); ?> · <?php echo e($tutor->name); ?></div>
                    </td>
                    <td><?php echo e($booking->duration_minutes); ?> min</td>
                    <td>R <?php echo e(number_format($booking->hourly_rate_snapshot, 2)); ?></td>
                    <td>R <?php echo e(number_format($amount, 2)); ?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="totals-wrap">
        <table class="totals-table">
            ...
            <tr>
                <td class="totals-label">VAT (<?php echo e($vatRate); ?>%)</td>
                <td>R <?php echo e(number_format($vatAmount, 2)); ?></td>
            </tr>
            <tr class="total-row">
                <td>Total Due</td>
    ...
    <!-- Footer -->
    <div class="footer">
        TeachMe App (Pty) Ltd · This is a system-generated invoice · <?php echo e($invoiceNumber); ?> · <?php echo e($issuedAt->format('d M Y H:i')); ?>

    </div>

</body>
</html><?php /**PATH C:\teachmeapp-laravel\resources\views\invoices\invoice.blade.php ENDPATH**/ ?>