...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.emails.layout','data' => ['subject' => __('Booking cancelled')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['subject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Booking cancelled'))]); ?>
    ...
    <div class="card">
        ...
        <div class="card-row">
            ...
            <span class="card-value"><?php echo e($cancelledBy); ?></span>
        </div>
        <?php if($penaltyApplied): ?>
        <div class="card-row">
            <span class="card-label">Cancellation fee</span>
            <span class="card-value">R<?php echo e(number_format($penaltyApplied, 2)); ?></span>
        </div>
        <?php endif; ?>
    </div>

    <div class="btn-wrap">
        <a class="btn" href="<?php echo e(config('app.url')); ?>/bookings">View My Bookings</a>
    </div>
...
<?php endif; ?><?php /**PATH C:\teachmeapp-laravel\resources\views\emails\booking-cancelled.blade.php ENDPATH**/ ?>